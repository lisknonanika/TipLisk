...
(function(){
  ...
  var TIPLSK_LINK = '<div style="margin: 5px 15px;font-size:12px;">' +
                    '<a href="https://lisknonanika.github.io/tiplsk-doc/howto.html" target="_blank">Tiplskの使い方</a>' +
                    '&nbsp;/&nbsp;' +
