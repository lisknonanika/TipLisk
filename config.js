...
var message = {
    "tipOk": ["{0} さんへ\n\n{1} さんから {2}LSK（約{3}円） チップが届きました！",
              "{0} さんへ\n\n{1} さんが {2}LSK（約{3}円） くれましたよ！",
              "{0} さんへ\n\n{1} さんが {2}LSK（約{3}円） チップをくれたみたい。",
              "{0} さんへ\n\n{2}LSK（約{3}円） {1}さんがくれたみたい。\nやったね！",
              "{0} さんへ\n\nなんと！\n{1} さんが {2}LSK（約{3}円） くれましたよ！",
              "{0} さんへ\n\n{1} さんからチップだよ！\n（ ・ω・）つ【{2}LSK（約{3}円）】",
              "{0} さんへ\n\n{1} さんが {2}LSK（約{3}円） くれるみたいですよ！",
              "{0} さんへ\n\n{1} さんが {2}LSK（約{3}円） くれましたー！",
              "{0} さんへ\n\n{1} さんがあなたにって {2}LSK（約{3}円） くれましたよ？\n今日は何かのお祝いですか？",
              "{0} さんへ\n\nやったやん！\n{1} さんから {2}LSK（約{3}円） 届いたで！",
              "{0} さんへ\n\n{1} さんから {2}LSK（約{3}円） だーよー！",
              "{0} さんへ\n\n{2}LSK（約{3}円）が {1} さんから届きました！",
              "{0} さんへ\n\nおぉ！？\n{1} さんが {2}LSK（約{3}円） くれたよ！"],
